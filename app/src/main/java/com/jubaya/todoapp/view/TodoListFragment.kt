...
import com.jubaya.todoapp.databinding.FragmentTodoListBinding
import com.jubaya.todoapp.viewmodel.ListTodoViewModel
    ...
    fun observeViewModel() {
        ...
        viewModel.todoLoadErrorLD.observe(viewLifecycleOwner, Observer {
            if(it == false) {
                ...
                binding.txtError.text = "Sorry we could not load your Todo list. Please Try again"
            }
        })
    }
